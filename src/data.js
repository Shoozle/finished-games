const gamesData = [
    ...
    },
    {
        ...
        beaten: 1,
        lastPlayed: 2026,
        comment: `A really fun combat system that evolved from MHS2 well. Loved the Rise/Sunbreak representation. Story was a bit wank and wish new characters joined as it went on. The demo was neat but never beat Namielle, sad!`,
        imgLoc: `/img/Monster Hunter Stories 3.jpg`
    },
    {
    ...
    },
    {
        ...
        beaten: 1,
        lastPlayed: 2025,
        comment: `The main story is so ass. The kid sucks. The Seikret sucks. Some fights are good but new monsters as a whole are boring. HR is much better. Nice to see some returning 4U guys. Prolapse anus bug is cool. Miss the old Mon Hun. None-hunting quests, canteens, item boxes, Mon Hun language... all gone!`,
